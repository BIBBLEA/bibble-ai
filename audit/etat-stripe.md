...
|---|---|---|
| Activation | **Compte activé** — confirmé par la cliente le 2026-08-04 *(au moment de l'audit, le dashboard live ne donnait accès qu'aux sandboxes)* | OK |
...
1. ~~Activer le compte Stripe live~~ — **fait** (activation confirmée par la cliente le 2026-08-04). Le passage en production n'est donc plus bloqué par un délai administratif ; reste à surveiller d'éventuelles demandes de justificatifs complémentaires de Stripe, qui suspendraient les virements.
...
2. ~~Activation du compte live par la cliente~~ — fait.
