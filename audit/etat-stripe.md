...
|---|---|---|
| Activation | **Compte NON activé** — le dashboard live ne donne accès qu'aux sandboxes | 🔴 bloquant |
| Webhooks live | Aucun (inaccessible tant que le compte n'est pas activé) | 🔴 |
| Paiements réels | Impossibles en l'état | 🔴 |
...
1. **Activer le compte Stripe live** (informations société, identité, IBAN). Sans cela : pas de clés live, pas de webhook live, pas de revenus. C'est un préalable administratif que seule la cliente peut faire.
...
2. Activation du compte live par la cliente.
