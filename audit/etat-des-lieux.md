...
Côté cliente, l'**activation du compte Stripe live** est le préalable administratif à tout
lancement : à déclencher dès maintenant, la validation prend plusieurs jours.
